...
// System
#define Error_System_FailToInitializeSocket 1001   /* 初始化Socket错误 */
#define Error_System_NotAvailableTradeServer 1002  /* 没有有效的交易服务器 */
#define Error_System_FailToLoad 1003               /* 加载出错 */
#define Error_System_VersionNotSupport 1004        /* 版本不支持 */
// Account
